...
const HierarchicalSidebar = () => {
    ...
    console.log("Edge to edge: ",edgeToEdge, nodeToEdge, )
  return (
    <>
            ...
            <div className="border-b">
              ...
              {isGeneralOpen && (
                <div className="pb-4">
                  ...
                  {/* Rest of the sliders remain the same */}
                  <div className="mt-3">
                  ...
                  <div className="mt-3">
                    <div className="flex items-center mt-2 justify-between">
                      <label className="text-sm text-black">Selected Elements Incrementally</label>
            ...
            {/* Edges and Labelling panels remain unchanged */}
            <div className="border-b">
                ...
                <div className="pb-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <input type="number" className="w-20 p-1 border rounded" defaultValue={4} />
                    </div>
                  </div>
                </div>
              )}
